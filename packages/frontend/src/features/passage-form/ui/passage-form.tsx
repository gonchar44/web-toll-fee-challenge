...
import { PassageCard } from "@/features/passages/ui/passage-card";
...
export function PassageForm() {
    ...
    const [recentPassage, setRecentPassage] = useState<Passage | null>(null);
    ...
    return (
        <div className="column is-3">
            ...
            {recentPassage && (
                <div className={styles.recentPassage}>
                    <p className={styles.recentPassageLabel}>Just recorded</p>
                    <PassageCard passage={recentPassage} />
                </div>
            )}
        </div>
    );
